...
class App:
    ...
    def __init__(self,
        ...
        self.cur_timestamp_pst = str(
                replay_start_time.to_pst())  # Formatted time slice in PST
    ...
    def __eq__(self, other):
        ...
        res = (self.name == other.name and
               self.replay_start_time == other.replay_start_time and
                self.loop_duration == other.loop_duration and
                self.rate == other.rate and
                self.base_url == other.base_url and
                self.identifier == other.identifier and
                self.cur_timestamp == other.cur_timestamp)

        return res

    def _is_valid_operand(self, other):
        return (hasattr(other, "name") and
                hasattr(other, "replay_start_time") and
                hasattr(other, "loop_duration") and
                hasattr(other, "rate") and
                hasattr(other, "base_url") and
